...
from download_video.download_video import DownloadVideo
...
if __name__ == "__main__":
    try:
        ...
        if sa.action == "download_video":
            dv = DownloadVideo(sa.project['name'], sa.selected_ids_filter, sa.entity_type)
